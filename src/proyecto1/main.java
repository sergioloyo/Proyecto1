            ...
            switch (opcion2) {
                case 1: {
                    ...
                    if (contadorCarro < 10) {
                        ...
                        try {
                            String dest = "D:\\Sergio\\Universidad\\4 Semestre\\01 Programación II\\Proyectos\\Proyecto1\\Reportes\\TicketCarro.PDF";
                ...
                case 2: {
                    ...
                    if (contadorMoto < 15) {
                        ...
                        try {
                            String dest = "D:\\Sergio\\Universidad\\4 Semestre\\01 Programación II\\Proyectos\\Proyecto1\\Reportes\\TicketMoto.PDF";
                            PdfWriter writer = new PdfWriter(dest);
                            PdfDocument pdfDoc = new PdfDocument(writer);
                            Document document = new Document(pdfDoc);
                            pdfDoc.addNewPage();
                ...
                case 3: {
                    ...
                    if (contadorCamion < 5) {
                        ...
                        try {
                            String dest = "D:\\Sergio\\Universidad\\4 Semestre\\01 Programación II\\Proyectos\\Proyecto1\\Reportes\\TicketCamion.pdf";
                            PdfWriter writer = new PdfWriter(dest);
                            PdfDocument pdfDoc = new PdfDocument(writer);
                            Document document = new Document(pdfDoc);
                            pdfDoc.addNewPage();
